    ...
    <div className="modal-wrapper">
      <div className="modal">
        ...
        <div className="modal__field">
          <Field handler={handlerModalInput} label="label_modal" validhandlerDelete={clearInput} value={inputModal} placeholder="Commit hush" styleHeader="initial" sizefield="field--s" header="Enter the commit hash which you want to build." />
        </div>
